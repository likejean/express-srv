function patchProcedureCalibratorRecord() {
  ...
  //get this helper function from utils...
    procedureCalibratorPatchRequestData = filterObjectAndTransform(_articlefactory.inputWrappers, (item) => item.status === true);    

    console.log(procedureCalibratorPatchRequestData, id);
