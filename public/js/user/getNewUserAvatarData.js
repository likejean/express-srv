const avatarForm = document.getElementById("user-account-avatar");
...
Object.entries(_userfactory.newUserFormInputs).forEach(([key, obj]) => {	
    ...
    if(key !== "avatar" && (key === "description" || key === "title")) avatarForm.elements[key].value = obj.value;	
...
//Attach eventListener to New Avatar Form data Submission event
avatarForm.addEventListener("submit", submitNewAvatarImageData);
