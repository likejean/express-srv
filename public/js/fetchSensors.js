...
const fetchSensors = async () => {
    try {
    // fetch data using POST API endpoint        
    ...
    function createIcon(idx, sensor){ 
        const cell = document.createElement("td"); 
        cell.innerHTML =
        `<i id=${idx} onClick="showSensorDetailsAndSettings('${idx}','${sensor.description}','${sensor.manufacturer}','${sensor.units}','${sensor.expirationDate}')" class='fa-sharp-duotone fa-solid fa-gear'></i>`;        
        return cell;
    }
